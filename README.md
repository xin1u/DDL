...
```bash
git clone <this-repository-url> DDL
cd DDL
...
For distributed training, use `torchrun --nproc_per_node=N` before the training
script. All official scripts support both single-GPU and DDP execution.
