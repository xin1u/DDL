...
class GradientOrthogonalLoss:
    ...
    def compute(net, loss_gen, loss_res):
        ...
        grads_gen = torch.autograd.grad(
            loss_gen, params, retain_graph=True, create_graph=True, allow_unused=True)
        grads_res = torch.autograd.grad(
            loss_res, params, retain_graph=True, create_graph=True, allow_unused=True)
...
if __name__ == '__main__':
    from ddl_arch import DDLRestorationNet
