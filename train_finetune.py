...
from configs.ddl_tasks import TMAT_TABLE, tmat_for_task
...
parser.add_argument('--experiment_name', type=str, default="ddl_gef")
...
if args.tmat is None:
    args.tmat = tmat_for_task(args.task) if args.task.lower() in TMAT_TABLE else 25
