...
from configs.ddl_tasks import TASKS, selected_tasks
...
parser.add_argument('--experiment_name', type=str, default="ddl_unified")
...
task_order = selected_tasks(args.tasks)
